...
1.5.7
 - PLAT-2826 - OpenTDF Use base64 hash values instead hex hash value for segments and root signature in encoded TDFs
...
1.5.2
 - PLAT-2665 - Move TDFStorageType c interface to separate files
