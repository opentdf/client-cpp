...
PYBIND11_MODULE(opentdf, tdf) {
    ...
    py::class_<TDFClient>(tdf, "TDFClient")
        ...
        .def("with_data_attributes", &TDFClient::withDataAttributes, py::arg("attribute_list"), R"pbdoc(
               Add data attributes

              Args:
                 attribute_list(list): Add the data attributes in the list
            )pbdoc");
    ...
    py::class_<NanoTDFClient>(tdf, "NanoTDFClient")
        ...
        .def("with_data_attributes", &NanoTDFClient::withDataAttributes, py::arg("attribute_list"), R"pbdoc(
               Add data attributes
    ...
    py::class_<NanoTDFDatasetClient>(tdf, "NanoTDFDatasetClient")
        ...
        .def("with_data_attributes", &NanoTDFDatasetClient::withDataAttributes, py::arg("attribute_list"), R"pbdoc(
               Add data attributes
