...
namespace virtru {
    ...
    void NanoTDFDatasetClient::addDataAttribute(const std::string& dataAttribute, const std::string& kasURL) {
        m_nanoTdfClient->addDataAttribute(dataAttribute, kasURL);
    }
