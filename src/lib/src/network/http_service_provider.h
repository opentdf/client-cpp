...
namespace virtru::network {
    ...
    public: // INetwork
        ...
        void executeGet(const std::string& url, const HttpHeaders& headers, HTTPServiceCallback&& callback) override;
        ...
        /// \param callback - The response callback.
        void executePost(const std::string& url, const HttpHeaders& headers,
        ...
        /// \param body - The HTTP body part of the request
        /// \param callback - The response callback.
        void executePatch(const std::string& url, const HttpHeaders& headers,
                          std::string&& body, HTTPServiceCallback&& callback) override;
